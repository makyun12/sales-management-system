...
GitHub上では、以下の画面キャプチャを追加するとプロジェクト内容が伝わりやすくなります。
...
画像を配置した後、READMEには例えば以下のように記述できます。
...
Adding screenshots to the GitHub repository will make the project easier to understand.
